  ...
  const copy = [
    ...
    },
    {
      portfolio: {
        type: "web",
        title: "Portfolio",
        text: "This portfolio was custom built from scratch using React. I wanted to create a visual history of my work experience, spanning both web development and product design projects I've worked on through my career. Content playfully presents itself as the user moves down the page.",
      ...
      pollbox: {
        type: "web",
        title: "Portfolio",
        text: "Inspired by the polls found on IGN's website, this component allows you to integrate a simple survey into your product. By design, it is fully responsive and allows a high degree of customization (colors, fonts, size, etc.). Integration details can be found on GitHub.",
        url: "https://poll-box.brendan-debusk.workers.dev/",
        git: "https://github.com/brendandebusk/poll-box",
      },

      footprint: {
        type: "web",
        title: "Footprint",
        text: "I developed Footprint out my own personal frustration with job application tracking. After pivoting careers in 2022, it's been a challenge to find a role as a fresh developer, leading to an insurmountable number of job applications. I was looking for a simple tool that would allow me to retire my spreadsheets and made it easy to see all of the applications that I was tracking, but nothing seemed to exist that fit the bill. So, I made my own tool and decided to put it out into the world for others to use.\n\nFrontend built using React.\n\nBackend built using AWS DynamoDB, Lambda, Cognito, and API Gateway.",
        url: "https://www.leaveyourfootprint.io",
      },
    },``
  ];
    ...
    <div className="overlay" onClick={(useCallback = () => props.reset())}>
      <div className="overlay-container">
        <div
          ...
          onClick={(useCallback = () => props.reset())}
        >
          +
        </div>
